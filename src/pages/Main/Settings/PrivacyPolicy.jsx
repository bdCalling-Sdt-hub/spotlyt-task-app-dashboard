...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="relative ml-[24px] ">
      ...
      <div
        className=" text-justify mt-[24px] max-h-[80%] overflow-y-auto border-2 border-[#318130] p-2 text-black"
        dangerouslySetInnerHTML={{ __html: content }}
      ></div>
      <Link
        to="/settings/edit-privacy-policy"
        className="absolute text-center bottom-[-60px] bg-gradient-to-r from-[#318130] via-[#318130] to-[#318130] 
