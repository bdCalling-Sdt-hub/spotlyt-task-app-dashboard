        ...
        <div>
            ...
            <div className="w-[80%] mx-auto border-2 rounded-lg border-[#318130]">
                ...
                <div className="px-4 bg-[#EAF2EA]">
                    ...
                    <h1 className="flex gap-2 items-center text-xl bg-[#318130;] w-[30%] py-2 px-4 text-white justify-center font-bold rounded-md"><FaFacebook /> Facebook</h1>
                    <div>
                        <h1 className="py-2 text-2xl text-[#318130] font-medium">Services:</h1>
                        <ul className="py-1 ml-5">
                            <li className="my-1 text-xl flex items-center gap-2"><FaDotCircle className="text-[15px] text-[#318130;]" /> Facebook</li>
                            <li className="my-1 text-xl flex items-center gap-2"><FaDotCircle className="text-[15px] text-[#318130;]" /> Facebook</li>
                            <li className="my-1 text-xl flex items-center gap-2"><FaDotCircle className="text-[15px] text-[#318130;]" /> Facebook</li>
                        </ul>
                    </div>
