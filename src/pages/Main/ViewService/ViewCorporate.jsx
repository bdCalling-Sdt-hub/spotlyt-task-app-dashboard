...
const ViewCorporate = () => {
    return (
        ...
        <div className="w-[80%] mx-auto border-2 rounded-lg border-[#318130]">
            <h1 className="text-3xl bg-[#318130;] p-4 text-center text-white">{`Business Offerings`}</h1>
            <div className="px-4 bg-[#EAF2EA]">
                <h1 className="py-2 text-2xl text-[#318130;] font-medium">Categories:</h1>
                <h1 className="flex gap-2 items-center text-xl bg-[#318130;] w-[30%] py-2 px-4 text-white justify-center font-bold rounded-md"><MdBusinessCenter /> Corporate</h1>
                <div>
